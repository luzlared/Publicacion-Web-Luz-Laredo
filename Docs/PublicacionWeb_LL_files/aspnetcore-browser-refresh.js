setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44324/LL Publicacion Web/,ws://localhost:62910/LL Publicacion Web/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
